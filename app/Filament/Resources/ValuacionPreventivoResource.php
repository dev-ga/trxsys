...
use App\Filament\Resources\ValuacionPreventivoResource\Pages;
use App\Filament\Resources\ValuacionPreventivoResource\RelationManagers;

class ValuacionPreventivoResource extends Resource
{
    protected static ?string $model = ValuacionPreventivo::class;
                ...
                Forms\Components\Section::make('INFORMACION PRINCIPAL PARA LA CARGA DE LAS VALUACIONES')
                    ...
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('codigo')
                            ...
                            ->default(function () {
                                if (ValuacionPreventivo::max('id') == null) {
                                    $parte_entera = 0;
                                } else {
                                    $parte_entera = ValuacionPreventivo::max('id');
                                }
    ...
    {
        return [
            'index' => Pages\ListValuacionPreventivos::route('/'),
            'create' => Pages\CreateValuacionPreventivo::route('/create'),
            'edit' => Pages\EditValuacionPreventivo::route('/{record}/edit'),
        ];
    }
}